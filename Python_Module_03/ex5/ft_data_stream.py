...
if __name__ == "__main__":
    ...
    saved_events = []
    for _ in range(10):
        saved_events.append(next(stream))
    print(f"Built list of 10 events: {saved_events}")
    for event in get_event(saved_events):
        print(f"Got event from list: {event}")
        print(f"Remains in list: {saved_events}")
